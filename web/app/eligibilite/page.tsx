...
export const metadata: Metadata = {
  title: "Éligibilité au don du sang - Vérifiez si vous pouvez donner",
  description:
    "Vérifiez en quelques secondes si vous etes éligible au don de sang, de plaquettes ou de plasma. Outil gratuit basé sur les critères officiels.",
  alternates: { canonical: "/eligibilite" },
  openGraph: {
    title: "Suis-je éligible au don du sang ?",
    description: "Outil gratuit pour vérifier votre éligibilité au don du sang en France.",
  },
};

const TYPES = ["whole_blood", "platelets", "plasma"] as const;

export default function ÉligibilitéPage() {
  const faqSchema = {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Il faut avoir entre 18 et 70 ans, peser au moins 50 kg, etre en bonne santé générale et respecter le délai legal depuis le dernier don (56 jours pour le sang total, 28 jours pour les plaquettes, 14 jours pour le plasma).",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Le délai legal est de 56 jours (8 semaines) entre deux dons de sang total, 28 jours pour les plaquettes et 14 jours pour le plasma.",
        },
      },
      {
        "@type": "Question",
        name: "Peut-on donner son sang après un tatouage ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui, mais il faut attendre 4 mois après un tatouage ou un piercing avant de pouvoir donner son sang.",
        },
      },
    ],
  };
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <Breadcrumbs items={[{ label: "Éligibilité" }]} />
      ...
      <p className="mb-10 text-lg text-(--color-text-muted)">
        Vérifiez en quelques secondes si vous pouvez donner du sang, des
        plaquettes ou du plasma. Basé sur les critères officiels en France.
      </p>
      ...
      <section className="mt-12 mb-12">
        <h2 className="mb-6 text-2xl font-bold">
          Conditions générales du don du sang en France
        </h2>
        <div className="rounded-2xl border border-(--color-border) bg-(--color-surface) p-6">
          <ul className="space-y-3 text-(--color-text-muted)">
            ...
            <li className="flex items-start gap-3">
              <span className="mt-0.5 text-(--color-green)">&#10003;</span>
              <span>
                <strong className="text-(--color-text)">Santé</strong> :
                bonne santé générale, pas de maladie infectieuse en cours
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-0.5 text-(--color-green)">&#10003;</span>
              <span>
                ...
                délai de 4 mois après un tatouage ou piercing
              </span>
            </li>
          </ul>
        </div>
      ...
      <section className="mb-12">
        <h2 className="mb-6 text-2xl font-bold">
          Délais entre deux dons par type
        </h2>
      ...
      <div className="rounded-2xl border border-(--color-border) bg-(--color-surface) p-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1 rounded-lg border border-(--color-border) px-4 py-2 text-sm font-medium transition-colors hover:bg-(--color-surface-2)"
          >
            Conseils avant/après <ArrowRight className="h-3.5 w-3.5" />
          </Link>
        </div>
      </div>
    </div>
