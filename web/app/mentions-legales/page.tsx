...
export const metadata: Metadata = {
  ...
  description: "Mentions légales du site LifeDrop — informations sur l'editeur, l'hébergément et les droits d'auteur.",
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 md:py-16">
        <h1 className="mb-8 text-3xl font-extrabold md:text-4xl">Mentions légales</h1>

        <div className="space-y-8 text-sm leading-relaxed text-(--color-text-muted)">
          <section>
            <h2 className="mb-3 text-lg font-bold text-(--color-text)">Éditeur du site</h2>
            <p>
              LifeDrop est un projet étudiant à but non lucratif.<br />
          ...
          <section>
            <h2 className="mb-3 text-lg font-bold text-(--color-text)">Hébergement</h2>
            <p>
            ...
            <p className="mt-2">
              La base de données est hébergée par Supabase Inc.<br />
          ...
          <section>
            <h2 className="mb-3 text-lg font-bold text-(--color-text)">Propriété intellectuelle</h2>
            <p>
              L&apos;ensemble du contenu du site LifeDrop (textes, images, logos, code source)
              est protégé par le droit d&apos;auteur. Toute reproduction, meme partielle, est
              soumise à autorisation prealable.
            </p>
          </section>
