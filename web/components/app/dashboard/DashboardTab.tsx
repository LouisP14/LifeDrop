...
export function DashboardTab({
  ...
  return (
    <div className="px-4 pt-4 animate-[fadeInUp_400ms_ease-out]">
      {/* Header */}
      ...
      {/* Hero */}
      <div className="mb-6 overflow-hidden rounded-2xl border border-[var(--color-primary)]/20 bg-gradient-to-br from-[rgba(248,113,113,0.08)] to-transparent p-6 text-center">
      ...
      <button
        ...
        disabled={!canDonate}
        className="mb-6 flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--color-primary)] py-3.5 text-base font-bold text-white transition-all hover:opacity-90 active:scale-95 disabled:opacity-40"
      >
      ...
      <div className="mb-6 grid grid-cols-2 gap-3">
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 text-center">
          ...
          <div className="text-xs text-[var(--color-text-muted)]">don{count !== 1 ? "s" : ""}</div>
        </div>
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 text-center">
      ...
      <button
        ...
        className="mb-4 flex w-full items-center gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 text-left transition-colors hover:bg-[var(--color-surface-2)]"
      >
