...
export function WelcomeStep({ onNext }: { onNext: () => void }) {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4 text-center animate-[fadeInUp_600ms_ease-out]">
      ...
      <p className="mb-6 mt-6 text-lg text-[var(--color-text-muted)]">
        Chaque don compte. Chaque vie aussi.
      </p>

      <div className="mb-10 inline-flex items-center gap-2 rounded-full border border-[var(--color-primary)]/20 bg-[var(--color-primary)]/5 px-5 py-2.5 text-sm">
      ...
      <button
        onClick={onNext}
        className="rounded-xl bg-[var(--color-primary)] px-10 py-4 text-base font-bold text-white transition-all hover:opacity-90 active:scale-95"
      >
